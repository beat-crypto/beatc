...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted BeatCOIN to zBEATC");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBEATC");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received BeatCOIN from zBEATC");
    case TransactionRecord::ZerocoinSpend_Change_zBEATC:
        return tr("Minted Change as zBEATC from zBEATC Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBEATC to BeatCOIN");
