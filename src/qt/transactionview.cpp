                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BeatCOIN from zBEATC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBEATC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBEATC));
